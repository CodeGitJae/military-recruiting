...
import com.gomilitary.api.repository.ArmyRepository;
...
public class ArmyService {
	...
	//			System.out.println(jsonArray);
				...
				armyEntity saveData = new armyEntity();
	...
	//								"#########teukgiName: " +teukgiName);
					...
					boolean existsCodeNum = armyRepository.existsByTeukgiCode(teukgiCode);
	//				System.out.println("existsCodeNum:::::::::::::::::::::"+existsCodeNum);
					boolean existsCodeStr =  armyRepository.existsByTeukgiCodeStr(teukgiCodeStr);
	//				System.out.println("existsCodeStr:::::::::::::::::::::"+existsCodeStr);
					...
					if(teukgiCodeObj instanceof Number && !existsCodeNum) {
						...
						saveData = new armyEntity(null, teukgiCode, null, gunGubun, teukgiName);
						armyRepository.save(saveData);
	//					System.out.println("#########saveData: " + saveData);
						...
						saveData = new armyEntity(null, null, teukgiCodeStr, gunGubun, teukgiName);
						armyRepository.save(saveData);
	//					System.out.println("#########saveData: " + saveData);
					}				
				}
